...
class TransitionElement:
    ...
    def update(self, dt):
        ...
        Returns:
            bool: True if the element is still on screen, False if it has fallen off
        """
...
class TransitionAnimation:
    ...
    def start(self, ui_elements, target_scene=None):
        """
        ...
        for image, rect in ui_elements:
            self.elements.append(TransitionElement(image, rect))
